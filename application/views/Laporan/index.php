                ...
                <div class="card mt-2">
                    <div class="card-header">
                        <form action="" method="POST">
                            <div class="row" style="position: relative;margin-left:60%">
                                <div class="col">
                               ...
                               <a href="<?php echo base_url('Laporan/cetak')?>/<?php echo $xtanggalA.'/'.$xtanggalB ;?>" target="_blank" class="btn btn-danger mt-2">cetak</a>
                            </div>
                        </form>
                    </div>
                </div>
